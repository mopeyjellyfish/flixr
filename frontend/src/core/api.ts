...
export type ScanPolicy = { library_id: string; enabled: boolean; schedule_kind: 'interval' | 'daily'; interval_seconds: number; local_time: string; timezone: string; next_run_at?: number; exclusions: string[] };
