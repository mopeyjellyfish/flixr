...
export const api = {
  ...
  playbackPlan: (catalogID: string, capabilities: PlaybackCapabilities, continueWatchingIntent: 'user' | 'recovery' | 'automatic' = 'user') => request<PlaybackPlan>('/playback/plans', { method: 'POST', body: JSON.stringify({ catalog_id: catalogID, continue_watching_intent: continueWatchingIntent, capabilities }) }),
