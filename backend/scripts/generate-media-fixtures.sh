...
ffmpeg -hide_banner -loglevel error -y -f lavfi -i 'sine=frequency=880:sample_rate=48000:duration=2' -c:a aac -metadata:s:a:0 language=jpn -metadata:s:a:0 title='Director Commentary' "$tv/Signal S01E01.jpn.Director Commentary.m4a"
