...
func (c *Catalog) browseMemory(query string, offset, limit int) []Item {
	...
	for _, series := range c.series {
		all = append(all, Item{ID: series.ID, Title: series.Title, Kind: "series", LocalOnly: series.LocalOnly, ProviderID: series.ProviderID, Year: series.Year, Synopsis: series.Synopsis, Poster: series.Poster, Backdrop: series.Backdrop})
	}
