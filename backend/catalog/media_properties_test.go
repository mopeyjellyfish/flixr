...
func TestPre011CatalogDatabaseMigratesLegacyTrackIndexes(t *testing.T) {
	...
	_, err = raw.Exec(`
		...
		CREATE TABLE catalog_series (id TEXT PRIMARY KEY, title TEXT NOT NULL, local_only INTEGER NOT NULL DEFAULT 1, provider_id TEXT NOT NULL DEFAULT '', year INTEGER NOT NULL DEFAULT 0, synopsis TEXT NOT NULL DEFAULT '', poster TEXT NOT NULL DEFAULT '', backdrop TEXT NOT NULL DEFAULT '', updated_at INTEGER NOT NULL DEFAULT 0, genres_json TEXT NOT NULL DEFAULT '[]', added_at INTEGER NOT NULL DEFAULT 0, playable INTEGER NOT NULL DEFAULT 1, demo INTEGER NOT NULL DEFAULT 0);
		CREATE TABLE catalog_items (id TEXT PRIMARY KEY, kind TEXT NOT NULL, title TEXT NOT NULL, relative_path TEXT NOT NULL, local_only INTEGER NOT NULL DEFAULT 1, root_kind TEXT NOT NULL DEFAULT 'film', updated_at INTEGER NOT NULL DEFAULT 0, fingerprint TEXT NOT NULL DEFAULT '', container TEXT NOT NULL DEFAULT '', video_codec TEXT NOT NULL DEFAULT '', audio_json TEXT NOT NULL DEFAULT '[]', subtitle_json TEXT NOT NULL DEFAULT '[]', size_bytes INTEGER NOT NULL DEFAULT 0, mtime_unix INTEGER NOT NULL DEFAULT 0, series_id TEXT NOT NULL DEFAULT '', season_id TEXT NOT NULL DEFAULT '', provider_id TEXT NOT NULL DEFAULT '', year INTEGER NOT NULL DEFAULT 0, synopsis TEXT NOT NULL DEFAULT '', poster TEXT NOT NULL DEFAULT '', backdrop TEXT NOT NULL DEFAULT '', video_profile TEXT NOT NULL DEFAULT '', genres_json TEXT NOT NULL DEFAULT '[]', added_at INTEGER NOT NULL DEFAULT 0, playable INTEGER NOT NULL DEFAULT 1, demo INTEGER NOT NULL DEFAULT 0);
	`)
	if err != nil {
		raw.Close()
		t.Fatal(err)
