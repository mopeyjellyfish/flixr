...
ALTER TABLE catalog_items ADD COLUMN owner_unmatched INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE catalog_series ADD COLUMN owner_unmatched INTEGER NOT NULL DEFAULT 0;
