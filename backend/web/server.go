...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/v1/owner/episode-orders", s.episodeOrders)
	s.mux.HandleFunc("GET /api/v1/owner/episode-orders/{id}", s.episodeOrder)
	s.mux.HandleFunc("PUT /api/v1/owner/episode-orders/{id}", s.episodeOrder)
	s.mux.HandleFunc("GET /api/v1/owner/episode-orders/{id}/groups", s.episodeOrderGroups)
	s.mux.HandleFunc("POST /api/v1/owner/episode-orders/{id}/preview", s.episodeOrderPreview)
	...
	s.mux.HandleFunc("POST /api/v1/playback/handoffs/{id}", s.playbackHandoff)
